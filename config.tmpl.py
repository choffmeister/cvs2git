...
# email address (e.g., "J. Random <address@hidden>" for the
...
author_transforms={
    ...
    'cvs2git' : ('cvs2git converter', 'address@hidden'),
    }
...
run_options.set_project(
    ...
    symbol_transforms=[
        ...
        #PickyIgnoreSymbolTransform('auc-tex.el', 'release_5_2', '5.3')
        ],
